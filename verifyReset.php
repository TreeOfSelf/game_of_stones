...
$query = "SELECT * FROM Users WHERE name = '$user' AND lastname = '$last' AND email = '$pass'";
...
mysqli_query($db,"DELETE FROM Reset WHERE email='$pass'");
...
// Send
mail($pass, 'Password Reset', $message);

$sql = "INSERT INTO Reset (email, code, name, lastname) VALUES ('$pass','$code','$user','$last')";
...
<br><br>
<?php
echo "<center><b>Access Denied:</b> No such matching Character and Email";
}
else
{
