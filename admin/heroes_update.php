...
mysqli_query($db,"LOCK TABLES Users WRITE, Users_stats WRITE, messages WRITE, Profs WRITE, Estate WRITE, Soc WRITE, Soc_stats WRITE;");
if (!$lastBattleDone)
{
