...
mysqli_query($db,"LOCK TABLES Hordes WRITE, Contests WRITE, Locations WRITE, Estates WRITE, messages WRITE, Items WRITE, Profs WRITE, Users WRITE, Users_Stats WRITE;");
