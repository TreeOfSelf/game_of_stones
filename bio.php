...
$name = mysqli_real_escape_string($db, strval($_GET['name']));
$submitted = mysqli_real_escape_string($db, strval($_POST['submitted']));
$lastname = mysqli_real_escape_string($db, strval($_GET['last']));
...
$result = mysqli_query($db, "SELECT * FROM Users LEFT JOIN Users_data ON Users.id=Users_data.id WHERE Users.name='$name' AND Users.lastname='$lastname'");
...
$char = $charb;
if (!$char['born']) {
    echo "<center><br><br><font class='medtext'>$name $lastname does not exist";
    include('footer.htm');
    exit;
}
                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body abox">
                                    <div class="btn-group-vertical btn-block">
                                        ...
                                        if ($char['society'] != $charother['society'] &&
                                            ($societyo['invite'] == 1 ||
                                                ...
                                                $socnameother)) {
                                            ?>
                                            <a href="messages.php?<?php echo "name=$name&last=$lastname&time=$time&join=59320112"; ?>"
                                    ...
                                    if (!isset($friends[$char['id']]['0'])) {
                                        ?>
                                        <a href="bio.php?<?php echo "set_s=1&time=$time&name=$name&last=$lastname"; ?>"
                                        ...
                                        <a href="bio.php?<?php echo "set_s=2&time=$time&name=$name&last=$lastname"; ?>"
                                        ...
                                        ?>
                                        <a href="bio.php?<?php echo "set_s=3&time=$time&name=$name&last=$lastname"; ?>"
